...
namespace neu
{
	...
	public:
		...
		static Matrix33 CreateTranslation(const vec2& position);
	...
	{
		// | rows[0][0], rows[0][1], rows[0][2] |   | mx[0][0], mx[0][1], mx[0][2] |
		// | rows[1][0], rows[1][1], rows[1][2] | * | mx[1][0], mx[1][1], mx[1][2] |
		// | rows[2][0], rows[2][1], rows[2][2] |   | mx[2][0], mx[2][1], mx[2][2] |
	...
	inline Matrix33 Matrix33::CreateTranslation(const vec2& position)
	{
		// | 1 0 x |
		// | 0 1 y |
		// | 0 0 1 |
